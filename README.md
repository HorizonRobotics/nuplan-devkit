...
This is a custom-maintained version of the NuPlan, which we term version 1.3rc for now. We make some changes based on the official NuPlan-devkit v1.2 and make it easier for R&D purposes.

(All copyrights of the [NuPlan devkit](https://github.com/motional/nuplan-devkit) goes to the original author)
...
* Fixed a Ray problem during simulation, which continuously consumes more GPU memory until the program crashes.